...
$consulta = "SELECT e.nro_expediente, e.fecha_recepcion, e.anio_recepcion,
a.area as remitente, o.objeto, d.dependencia, CONCAT(f.nombre,' ',f.apellido) as recepciono
FROM expedientes e JOIN areas a 
ON e.id_area = a.id_area JOIN objetos o
ON e.id_objeto = o.id_objeto JOIN dependencias d
ON e.id_dependencia = d.id_dependencia JOIN funcionarios f
...
<body>
    ...
    <hr>
    <h2 style="text-align: center;">LISTA DE EXPEDIENTES</h2>
...
$dompdf->stream('lista_expedientes.pdf', array('Attachment' => false));
?>
