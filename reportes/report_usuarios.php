...
$consulta = "SELECT CONCAT(f.nombre,' ' ,f.apellido) as funcionario, u.usuario, u.correo, r.rol FROM usuarios u JOIN funcionarios f ON u.id_funcionario = f.id_funcionario JOIN roles r ON u.id_rol = r.id_rol;";
